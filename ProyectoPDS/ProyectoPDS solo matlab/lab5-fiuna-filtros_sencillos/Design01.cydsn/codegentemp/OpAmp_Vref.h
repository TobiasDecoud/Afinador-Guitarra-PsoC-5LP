...
#define OpAmp_Vref_TR0_REG                (* (reg8 *) OpAmp_Vref_ABuf__TR0)
#define OpAmp_Vref_TR0_PTR                (  (reg8 *) OpAmp_Vref_ABuf__TR0)
...
#define OpAmp_Vref_MX_VN_AG4              (0x10u)
#define OpAmp_Vref_MX_VN_AG6              (0x20u)

/* Bit Field  MX_VP */
#define OpAmp_Vref_MX_VP_MASK             (0x0Fu)
#define OpAmp_Vref_MX_VP_NC               (0x00u)
#define OpAmp_Vref_MX_VP_VREF             (0x09u)
#define OpAmp_Vref_MX_VP_AG4              (0x01u)
#define OpAmp_Vref_MX_VP_AG5              (0x02u)
#define OpAmp_Vref_MX_VP_AG6              (0x03u)
#define OpAmp_Vref_MX_VP_AG7              (0x04u)
#define OpAmp_Vref_MX_VP_ABUS0            (0x05u)
#define OpAmp_Vref_MX_VP_ABUS1            (0x06u)
#define OpAmp_Vref_MX_VP_ABUS2            (0x07u)
#define OpAmp_Vref_MX_VP_ABUS3            (0x08u)
